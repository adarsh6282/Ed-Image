...
export class ImageRepository implements IImageRepository{
    ...
    async updateImageById(id:string,updateData:Partial<IImage>):Promise<IImage|null> {
    ...
    async updatePosition(imageId: string, newPos: number, userId: string):Promise<IImage|null> {
